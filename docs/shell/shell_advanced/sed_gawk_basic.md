...
```bash
$ echo "This 1 is a text of 1 try." | sed 'y/123/456/'
This 4 is a text of 4 try.
$ 
```
...
```bash
# 可能是nvim设置了4个空格为tab,为了契合教材，data7.txt为vim写入,输出同教材相同
$ cat data7.txt 
...
Harken, C     Alliance
$ 
$ sed -n '/Browncoat/w Browncoats.txt' data9.txt 
$ 
$ cat Browncoats.txt 
Blum, R       Browncoat
Bresnahan, C  Browncoat
...
This is line number 4.
$ 
$ sed '/number 2/r data10.txt' data4.txt 
This is line number 1.
This is line number 2.
This is an added line.
This is the second added line
...
```bash
$ echo "My name is Rich" | gawk '{$4="Chirstine";print $0}'
My name is Chirstine
$ 
```
...
daemon's home directory is /
mail's home directory is /var/spool/mail
ftp's home directory is /srv/ftp
http's home directory is /srv/http
nobody's home directory is /
dbus's home directory is /
systemd-coredump's home directory is /
systemd-network's home directory is /
systemd-oom's home directory is /
systemd-journal-remote's home directory is /
[...]
```
